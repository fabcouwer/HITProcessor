...
// Decomposes an image of a web page into an XML representation
// Based on DecomposeImageExample.java
public class ImageDecomposition {

	// Accepts image at inputFileName.
	// Writes XML result to outputFileName.
	public static void decomposeSingleImage(String inputFileName,
	...
	public static void decomposeImageSet(String inputDir, String outputDir) {
		...
		for (int i = 9000; i < files.length; i++) {
			...
			// URL imageURL =
			// DecomposeImageExample.class.getResource(f.getAbsolutePath());
			try {
